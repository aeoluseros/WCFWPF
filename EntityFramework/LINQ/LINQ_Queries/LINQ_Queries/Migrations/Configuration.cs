...
namespace LINQ_Queries.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LINQ_Queries.PlutoContext>
    {
        ...
        protected override void Seed(LINQ_Queries.PlutoContext context)
        {
            ...
            foreach (var tag in tags.Values)
                context.Tags.AddOrUpdate(t => t.Id, tag);  //t.Id is used to identify records
            #endregion
